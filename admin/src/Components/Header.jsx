                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 bg-white rounded-5 p-1 me-1">
                                <li className="nav-item">
                                    <Link className="nav-link  me-1" aria-current="page" to="/hr-management/admin/dashboard">Dashboard</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link  me-1" aria-current="page" to="/hr-management/admin/employee">Employee</Link>
                                </li>
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link  me-1" aria-current="page" to="/hr-management/admin/leave-request">Requests</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link me-1" aria-current="page" to="#">Hiring</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link me-1" aria-current="page" to="/hr-management/admin/salary">Salary</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link" aria-current="page" to="#">Calendar</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link" aria-current="page" to="/hr-management/admin/archives">Archives</Link>
                                </li>
                            </ul>
