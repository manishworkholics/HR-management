              ...
              <ul>
                <li>
                  <a href="tel:(010) 1234 4321">
                    <i className="fas fa-phone fa-flip-horizontal"></i>(010) 1234 4321
                  </a>
                </li>
                <li>
                  <i className="fas fa-map-marker-alt"></i> 1 / 105 Bay Lights,
                  <br />Lorem Ipsum,
                  <br />LIC 3201
                </li>
              </ul>
              ...
              <div className="footer-logo">
                <table>
                  <tbody>
                    <tr>
                      <td>
                        <img src="https://i.ibb.co/vxc577d/dummy-logo3.jpg" alt="logo" />
                      </td>
                      <td>
                        <img src="https://i.ibb.co/vxc577d/dummy-logo3.jpg" alt="logo" />
                      </td>
